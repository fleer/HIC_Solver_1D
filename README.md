...
# Simulation of Quark-Gluon-Plasma in heavy-ion collisions with the help of relativistic viscous hydrodynamics (1+1 dimension) [![Build Status](https://travis-ci.com/fleer/HIC_Solver_1D.svg?token=sGDhmF9VD4p3i1s4BjQK&branch=master)](https://travis-ci.com/fleer/HIC_Solver_1D)
